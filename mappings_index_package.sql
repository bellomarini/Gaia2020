...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE "GAIA"."MAPPINGS_INDEX" AS 
    ...
    function l_rel(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of relations in the RHS
    function r_rel(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of existentially quantified variables
    function exist(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of joins in the LHS
    function l_join(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of joins in the RHS
    function r_join(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of relations in the LHS without any variable in common
    function l_cart(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of relations in the RHS without any variable in common
    function r_cart(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of joins along FKs in the LHS
    function l_join_fk(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of joins along FKs in the RHS
    function r_join_fk(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    ...
    function l_join_key(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of joins along a key in the RHS
    function r_join_key(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
    
    -- number of distinct variables copied from LHS to RHS
    function var_copied(v_mapping_id in varchar2, v_isTemplate number := 1) return number;
