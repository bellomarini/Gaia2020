...
create table "BILANA"."BANK2"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK0"(CODIMP),
	FORMGIU varchar2(60),
...
create table "BILANA"."BANK37"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK26"(CODIMP),
	STATOANAOCC varchar2(60),
	DATAINVIO varchar2(60),
	FLAGINF varchar2(60),
	PROVLEG varchar2(60),
...
create table "BILANA"."BANK53"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK34"(CODIMP),
	RAMO varchar2(60),
	STATOTAB15 varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB35 varchar2(60),
...
create table "BILANA"."BANK95"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK72"(CODIMP),
	CODBANCA varchar2(60),
	DATAAMM varchar2(60),
	DURLEG varchar2(60),
	RAMO varchar2(60),
...
create table "BILANA"."BANK100"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK88"(CODIMP),
	FLAGCBBANCHE varchar2(60),
	SCHEMARIL varchar2(60),
	DATAAMM varchar2(60),
	FORMGIU varchar2(60),
...
create table "BILANA"."BANK143"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK37"(CODIMP),
	STATOTAB18 varchar2(60),
	STATOTAB20 varchar2(60),
	DATAUPDT varchar2(60),
	STATOTAB71 varchar2(60),
...
create table "BILANA"."BANK152"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK69"(CODIMP),
	STATOCOMPCAP varchar2(60),
	SETTORE varchar2(60),
	SCHEMARICL varchar2(60),
	STATOTAB50 varchar2(60),
...
create table "BILANA"."BANK172"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK169"(CODIMP),
	NATURA varchar2(60),
	TIPOBIL varchar2(60),
	STATOTAB70 varchar2(60),
	CABLEG varchar2(60),
...
create table "BILANA"."BANK184"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK133"(CODIMP),
	ZONAOPE varchar2(60),
	STATORIC varchar2(60),
	SETTORE varchar2(60),
	FORMGIU varchar2(60),
...
create table "BILANA"."BANK221"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK170"(CODIMP),
	DENOMSTA varchar2(60),
	STATOMODLAV varchar2(60),
	STATOTAB05 varchar2(60),
	CODOPE varchar2(60),
...
create table "BILANA"."BANK243"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK115"(CODIMP),
	STATOTAB15 varchar2(60),
	FLAGD varchar2(60),
	STATOTAB10 varchar2(60),
	DURLEG varchar2(60),
...
create table "BILANA"."BANK247"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK2"(CODIMP),
	CODDIP varchar2(60),
	STATOTAB50 varchar2(60),
	FORMGIU varchar2(60),
	STATOTAB20 varchar2(60),
...
create table "BILANA"."BANK260"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK184"(CODIMP),
	STATOMODLAV varchar2(60),
	CODDIP varchar2(60),
	STATOTAB35 varchar2(60),
	STATOTAB20 varchar2(60),
...
create table "BILANA"."BANK266"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK168"(CODIMP),
	FLAGCBBANCHE varchar2(60),
	CODOPE varchar2(60),
	CABLEG varchar2(60),
	TIPOSOGG varchar2(60),
...
create table "BILANA"."BANK283"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK225"(CODIMP),
	STATOTAB16 varchar2(60),
	DATAAMM varchar2(60),
	ZONAOPE varchar2(60),
	LIREEURO varchar2(60),
...
create table "BILANA"."BANK287"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK214"(CODIMP),
	DENOMSTA varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB16 varchar2(60),
	CODISTAT varchar2(60),
...
create table "BILANA"."BANK322"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK245"(CODIMP),
	STATOTAB16 varchar2(60),
	FLAGCBBANCHE varchar2(60),
	SCHEMARIL varchar2(60),
	STATOANAREVIS varchar2(60),
...
create table "BILANA"."BANK347"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK64"(CODIMP),
	CABLEG varchar2(60),
	DATARIC varchar2(60),
	PROVOPE varchar2(60),
	STATOMODLAV varchar2(60),
...
create table "BILANA"."BANK376"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK309"(CODIMP),
	SETTORE varchar2(60),
	STATOTAB45 varchar2(60),
	FORMGIU varchar2(60),
	DATABIL varchar2(60),
...
create table "BILANA"."BANK388"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK211"(CODIMP),
	CODBANCA varchar2(60),
	CABLEG varchar2(60),
	CODISTAT varchar2(60),
	TIPOSOGG varchar2(60),
...
create table "BILANA"."BANK389"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK212"(CODIMP),
	DATAAMM varchar2(60),
	TIPOSOGG varchar2(60),
	PROVLEG varchar2(60),
	STRUTBIL varchar2(60),
...
create table "BILANA"."BANK398"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK354"(CODIMP),
	NATURA varchar2(60),
	STATORIL varchar2(60),
	STATOANAPRINC varchar2(60),
	STATOTAB18 varchar2(60),
...
create table "BILANA"."BANK401"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK175"(CODIMP),
	MODRIL varchar2(60),
	STATOMODLAV varchar2(60),
	CARBIL varchar2(60),
	STATORIL varchar2(60),
...
create table "BILANA"."BANK417"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK127"(CODIMP),
	NATURA varchar2(60),
	STATOANAREVIS varchar2(60),
	CODOPE varchar2(60),
	STATOANAVALSCORT varchar2(60),
...
create table "BILANA"."BANK425"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK65"(CODIMP),
	STATOCOMPCAP varchar2(60),
	FLAGCBBANCHE varchar2(60),
	TIPOCONT varchar2(60),
	SCHEMARICL varchar2(60),
...
create table "BILANA"."BANK442"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK235"(CODIMP),
	STATOCOMPCAP varchar2(60),
	STRUTBIL varchar2(60),
	PROVLEG varchar2(60),
	STATOTAB20 varchar2(60),
...
create table "BILANA"."BANK453"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK173"(CODIMP),
	SCHEMARIL varchar2(60),
	TIPOBIL varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB10 varchar2(60),
...
create table "BILANA"."BANK476"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK396"(CODIMP),
	NATURA varchar2(60),
	STATOTAB10 varchar2(60),
	LIREEURO varchar2(60),
	STATOTAB19 varchar2(60),
...
create table "BILANA"."BANK499"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK200"(CODIMP),
	NATURA varchar2(60),
	CABLEG varchar2(60),
	TIPOSOGG varchar2(60),
	STATOTAB30 varchar2(60),
