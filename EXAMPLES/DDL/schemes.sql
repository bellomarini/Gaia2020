...
create table "BILANA"."BANK23"(
	CODIMP varchar2(20) not null primary key references table4(CODIMP),
	DATABIL varchar2(60),
	STATORIC varchar2(60),
	CODCCIA varchar2(60),
...
create table "BILANA"."BANK54"(
	CODIMP varchar2(20) not null primary key references table46(CODIMP),
	TIPOBIL varchar2(60),
	STATOTAB71 varchar2(60),
	DATAINS varchar2(60),
	ZONAOPE varchar2(60),
...
create table "BILANA"."BANK55"(
	CODIMP varchar2(20) not null primary key references table47(CODIMP),
	DATAAMM varchar2(60),
	TIPOCONT varchar2(60),
	STATOCOMPCAP varchar2(60),
	CODOPE varchar2(60),
...
create table "BILANA"."BANK82"(
	CODIMP varchar2(20) not null primary key references table36(CODIMP),
	STATOANA varchar2(60),
	TIPOSOGG varchar2(60),
	STATOTAB20 varchar2(60),
	ATECO007 varchar2(60),
...
create table "BILANA"."BANK124"(
	CODIMP varchar2(20) not null primary key references table74(CODIMP),
	ZONALEG varchar2(60),
	DUROPE varchar2(60),
	CODCCIA varchar2(60),
	STATOTAB55 varchar2(60),
...
create table "BILANA"."BANK140"(
	CODIMP varchar2(20) not null primary key references table41(CODIMP),
	SETTORE varchar2(60),
	STATOANAPRINC varchar2(60),
	SETTORE varchar2(60),
	NATURA varchar2(60),
...
create table "BILANA"."BANK153"(
	CODIMP varchar2(20) not null primary key references table59(CODIMP),
	STATORIC varchar2(60),
	CABOPE varchar2(60),
	DATABIL varchar2(60),
	STATOANAOCC varchar2(60),
...
create table "BILANA"."BANK190"(
	CODIMP varchar2(20) not null primary key references table185(CODIMP),
	STATOTAB15 varchar2(60),
	DATAINVIO varchar2(60),
	STATORIC varchar2(60),
	CABLEG varchar2(60),
...
create table "BILANA"."BANK219"(
	CODIMP varchar2(20) not null primary key references table83(CODIMP),
	ZONAOPE varchar2(60),
	ATECO002 varchar2(60),
	STATOTAB71 varchar2(60),
	STATOANA varchar2(60),
...
create table "BILANA"."BANK222"(
	CODIMP varchar2(20) not null primary key references table169(CODIMP),
	ZONALEG varchar2(60),
	STATOTAB30 varchar2(60),
	STATOANA varchar2(60),
	ZONAOPE varchar2(60),
...
create table "BILANA"."BANK225"(
	CODIMP varchar2(20) not null primary key references table125(CODIMP),
	STATOTAB05 varchar2(60),
	STATOANAVALSCORT varchar2(60),
	STATOANA varchar2(60),
	FLAGINV varchar2(60),
...
create table "BILANA"."BANK237"(
	CODIMP varchar2(20) not null primary key references table153(CODIMP),
	STATONOR varchar2(60),
	LIREEURO varchar2(60),
	TIPOCONT varchar2(60),
	STATOANAPRINC varchar2(60),
...
create table "BILANA"."BANK240"(
	CODIMP varchar2(20) not null primary key references table110(CODIMP),
	REGLEG varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB20 varchar2(60),
	CARBIL varchar2(60),
...
create table "BILANA"."BANK244"(
	CODIMP varchar2(20) not null primary key references table155(CODIMP),
	STATOTAB31 varchar2(60),
	DATAAMM varchar2(60),
	STATOANAREVIS varchar2(60),
	DUROPE varchar2(60),
...
create table "BILANA"."BANK252"(
	CODIMP varchar2(20) not null primary key references table196(CODIMP),
	SETTORE varchar2(60),
	STATOCOMPCAP varchar2(60),
	STATOTAB10 varchar2(60),
	STATOTAB70 varchar2(60),
...
create table "BILANA"."BANK283"(
	CODIMP varchar2(20) not null primary key references table152(CODIMP),
	LIREEURO varchar2(60),
	FLAGINF varchar2(60),
	STATOANAVALSCORT varchar2(60),
	STATOTAB50 varchar2(60),
...
create table "BILANA"."BANK343"(
	CODIMP varchar2(20) not null primary key references table255(CODIMP),
	ZONALEG varchar2(60),
	STATOTAB62 varchar2(60),
	DUROPE varchar2(60),
	STATOTAB40 varchar2(60),
...
create table "BILANA"."BANK362"(
	CODIMP varchar2(20) not null primary key references table275(CODIMP),
	STATOTAB15 varchar2(60),
	DATARIC varchar2(60),
	STATOCOMPCAP varchar2(60),
	STATOTAB71 varchar2(60),
...
create table "BILANA"."BANK366"(
	CODIMP varchar2(20) not null primary key references table27(CODIMP),
	STATOTAB45 varchar2(60),
	STATOTAB05 varchar2(60),
	DUROPE varchar2(60),
	STATOTAB71 varchar2(60),
...
create table "BILANA"."BANK368"(
	CODIMP varchar2(20) not null primary key references table165(CODIMP),
	STATOANAREVIS varchar2(60),
	PROVLEG varchar2(60),
	DATARIC varchar2(60),
	FORMGIU varchar2(60),
...
create table "BILANA"."BANK377"(
	CODIMP varchar2(20) not null primary key references table181(CODIMP),
	PROVLEG varchar2(60),
	STATOTAB30 varchar2(60),
	STATORIC varchar2(60),
	NUMPATDED varchar2(60),
...
create table "BILANA"."BANK392"(
	CODIMP varchar2(20) not null primary key references table264(CODIMP),
	STATOCOMPCAP varchar2(60),
	STATOTAB70 varchar2(60),
	STATOTAB31 varchar2(60),
	DATAINS varchar2(60));
...
create table "BILANA"."BANK396"(
	CODIMP varchar2(20) not null primary key references table50(CODIMP),
	NUMPATDED varchar2(60),
	CABOPE varchar2(60),
	STATOTAB05 varchar2(60),
	STATOTAB45 varchar2(60),
...
create table "BILANA"."BANK405"(
	CODIMP varchar2(20) not null primary key references table33(CODIMP),
	STATOGENTAB varchar2(60),
	DATAUPDT varchar2(60),
	STATOANAPRINC varchar2(60),
	FLAGCBBANCHE varchar2(60),
...
create table "BILANA"."BANK406"(
	CODIMP varchar2(20) not null primary key references table215(CODIMP),
	STATOALTRICRITVAL varchar2(60),
	CODDIP0 varchar2(60),
	STATOPATDED varchar2(60),
	STATOALTRICRITVAL varchar2(60),
...
create table "BILANA"."BANK431"(
	CODIMP varchar2(20) not null primary key references table382(CODIMP),
	CABLEG varchar2(60),
	STATOTAB30 varchar2(60),
	STATOMODLAV varchar2(60),
	ZONAOPE varchar2(60));
...
create table "BILANA"."BANK437"(
	CODIMP varchar2(20) not null primary key references table166(CODIMP),
	STATOPATDED varchar2(60),
	DUROPE varchar2(60),
	RAMO varchar2(60),
	LIREEURO varchar2(60));
...
create table "BILANA"."BANK441"(
	CODIMP varchar2(20) not null primary key references table397(CODIMP),
	FLAGINV varchar2(60),
	PROVOPE varchar2(60),
	DATAINVIO varchar2(60),
	STATOTAB20 varchar2(60));
...
create table "BILANA"."BANK444"(
	CODIMP varchar2(20) not null primary key references table99(CODIMP),
	STATOTAB18 varchar2(60),
	STATOTAB45 varchar2(60),
	STATOTAB16 varchar2(60),
	STATOANAOCC varchar2(60),
...
create table "BILANA"."BANK446"(
	CODIMP varchar2(20) not null primary key references table339(CODIMP),
	SCHEMARIL varchar2(60),
	STATOTAB72 varchar2(60),
	STATOTAB55 varchar2(60),
	RAMO varchar2(60));
...
create table "BILANA"."BANK460"(
	CODIMP varchar2(20) not null primary key references table427(CODIMP),
	STATOTAB50 varchar2(60),
	STATOANAREVIS varchar2(60),
	SETTORE varchar2(60),
	CODISTAT varchar2(60),
...
create table "BILANA"."BANK467"(
	CODIMP varchar2(20) not null primary key references table458(CODIMP),
	TIPOCONT varchar2(60),
	STATOTAB20 varchar2(60),
	DATAINS varchar2(60),
	NATURA varchar2(60),
...
create table "BILANA"."BANK482"(
	CODIMP varchar2(20) not null primary key references table252(CODIMP),
	CARBIL varchar2(60),
	STATOTAB35 varchar2(60),
	STATOANAREVIS varchar2(60),
	FLAGD varchar2(60));
create table "BILANA"."BANK483"(
	CODIMP varchar2(20) not null primary key references table240(CODIMP),
	STATOTAB05 varchar2(60),
	DATABIL varchar2(60),
	FORMGIU varchar2(60),
	ZONALEG varchar2(60),
