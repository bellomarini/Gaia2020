...
create table "BILANA"."BANK28"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK13"(CODIMP),
	STATOTAB15 varchar2(60),
	STATOMODLAV varchar2(60),
	STATOTAB10 varchar2(60),
	STATOTAB72 varchar2(60),
...
create table "BILANA"."BANK49"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK44"(CODIMP),
	STATOANAREVIS varchar2(60),
	STATOTAB70 varchar2(60),
	STATOTAB35 varchar2(60),
	TIPOSOGG varchar2(60),
...
create table "BILANA"."BANK57"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK55"(CODIMP),
	STRUTBIL varchar2(60),
	NATURA varchar2(60),
	TIPOBIL varchar2(60),
	STATOANAREVIS varchar2(60),
...
create table "BILANA"."BANK134"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK50"(CODIMP),
	STATOTAB35 varchar2(60),
	STATOTAB71 varchar2(60),
	STATOTAB60 varchar2(60),
	STATORIC varchar2(60),
...
create table "BILANA"."BANK141"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK89"(CODIMP),
	DATAAMM varchar2(60),
	TIPOSOGG varchar2(60),
	STATOTAB30 varchar2(60),
	CODDIP0 varchar2(60),
...
create table "BILANA"."BANK150"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK85"(CODIMP),
	DENOMSTA varchar2(60),
	STATOTAB31 varchar2(60),
	FLAGINF varchar2(60),
	PROVLEG varchar2(60),
...
create table "BILANA"."BANK166"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK121"(CODIMP),
	STATOANAOCC varchar2(60),
	STATOANAATT varchar2(60),
	STATOANAPRINC varchar2(60),
	STATOPATDED varchar2(60),
...
create table "BILANA"."BANK167"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK58"(CODIMP),
	DENOMSTA varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB10 varchar2(60),
	REGOPE varchar2(60),
...
create table "BILANA"."BANK172"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK122"(CODIMP),
	STATOTAB62 varchar2(60),
	CABLEG varchar2(60),
	FLAGINV varchar2(60),
	STATOGENTAB varchar2(60));
...
create table "BILANA"."BANK193"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK171"(CODIMP),
	STATOANAOCC varchar2(60),
	NATURA varchar2(60),
	TIPOBIL varchar2(60),
	TIPOSOGG varchar2(60),
...
create table "BILANA"."BANK254"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK197"(CODIMP),
	DENOMSTA varchar2(60),
	STATOTAB15 varchar2(60),
	STATOMODLAV varchar2(60),
	DATARIC varchar2(60),
...
create table "BILANA"."BANK261"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK240"(CODIMP),
	CODBANCA varchar2(60),
	CODDIP varchar2(60),
	CODISTAT varchar2(60),
	DATAINS varchar2(60),
...
create table "BILANA"."BANK274"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK210"(CODIMP),
	STATOTAB16 varchar2(60),
	FLAGD varchar2(60),
	STATOTAB05 varchar2(60),
	PROVLEG varchar2(60),
...
create table "BILANA"."BANK289"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK244"(CODIMP),
	STATOTAB16 varchar2(60),
	FLAGD varchar2(60),
	STATOTAB19 varchar2(60),
	SCHEMARICL varchar2(60),
...
create table "BILANA"."BANK309"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK75"(CODIMP),
	NUMPATDED varchar2(60),
	DUROPE varchar2(60),
	CODBANCA varchar2(60),
	CODDIP varchar2(60));
...
create table "BILANA"."BANK348"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK196"(CODIMP),
	SCHEMARICL varchar2(60),
	MODRIL varchar2(60),
	TIPOBIL varchar2(60),
	STATOTAB30 varchar2(60),
...
create table "BILANA"."BANK365"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK302"(CODIMP),
	DENOMSTA varchar2(60),
	STATOANAATT varchar2(60),
	STATOTAB31 varchar2(60),
	LIREEURO varchar2(60),
...
create table "BILANA"."BANK372"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK91"(CODIMP),
	STATOTAB16 varchar2(60),
	STATOTAB15 varchar2(60),
	STATOTAB50 varchar2(60),
	STATOTAB31 varchar2(60),
...
create table "BILANA"."BANK393"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK332"(CODIMP),
	STATOCOMPCAP varchar2(60),
	DENOMSTA varchar2(60),
	TIPOBIL varchar2(60),
	STATOPATDED varchar2(60),
...
create table "BILANA"."BANK408"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK33"(CODIMP),
	STATOCOMPCAP varchar2(60),
	DENOMSTA varchar2(60),
	FLAGD varchar2(60),
	DURLEG varchar2(60),
...
create table "BILANA"."BANK446"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK349"(CODIMP),
	STATOMODLAV varchar2(60),
	STATOTAB19 varchar2(60),
	CODDIP varchar2(60),
	SCHEMARICL varchar2(60),
...
create table "BILANA"."BANK449"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK221"(CODIMP),
	STATOTAB71 varchar2(60),
	STATOCOMPCAP varchar2(60),
	CABOPE varchar2(60),
	STATOANA varchar2(60),
...
create table "BILANA"."BANK458"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK312"(CODIMP),
	STATOANAATT varchar2(60),
	CARBIL varchar2(60),
	DATAINS varchar2(60),
	STATOTAB75 varchar2(60),
...
create table "BILANA"."BANK461"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK435"(CODIMP),
	STATOCOMPCAP varchar2(60),
	STATOANAOCC varchar2(60),
	STATOANAPRINC varchar2(60),
	CODISTAT varchar2(60),
...
create table "BILANA"."BANK489"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK303"(CODIMP),
	SETTORE varchar2(60),
	STATOTAB05 varchar2(60),
	CODOPE varchar2(60),
	STATOTAB35 varchar2(60),
...
create table "BILANA"."BANK497"(
	CODIMP varchar2(20) not null primary key references "BILANA"."BANK266"(CODIMP),
	FLAGD varchar2(60),
	SETTORE varchar2(60),
	STATOTAB10 varchar2(60),
	DATAAMM varchar2(60),
